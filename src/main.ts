...
async function glMain() {
	...
	const font_size_input = document.getElementById('font_size') as HTMLInputElement

	const font_hinting_input = document.getElementById('font_hinting') as HTMLInputElement

	const subpixel_input = document.getElementById('subpixel') as HTMLInputElement

	const font_color_input = document.getElementById('font_color') as HTMLInputElement

	const bg_color_input = document.getElementById('background_color') as HTMLInputElement
